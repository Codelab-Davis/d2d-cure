...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/rahulbudhiraja/Downloads/MainBuildTest-DONTCODEHERE/d2d-cure/prisma/generated/client_enzymes",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineSchemaHash": "55f8c05d4c819c8eaa780f999a69b263a3792c41a23b1b3f0b7a0e307d98ccd2",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/generated/client_enzymes",
...
path.join(process.cwd(), "prisma/generated/client_enzymes/libquery_engine-darwin.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/client_enzymes/schema.prisma")
