...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/rahulbudhiraja/Downloads/MainBuildTest-DONTCODEHERE/d2d-cure/prisma/generated/client_users",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
  ...
  "inlineDatasources": {
    "db": {
      "url": {
        "fromEnvVar": null,
        "value": "mysql://admin:hellothere@d2ddb.ckxjdd4ew6cp.us-east-2.rds.amazonaws.com:3306/users"
      }
    }
  },
  ...
  "inlineSchemaHash": "67f0d82f2a67f6bf1bcff7a878f6872e62fb38545cdadea49211d051275beb42",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "prisma/generated/client_users",
    "generated/client_users",
  ]
...
path.join(process.cwd(), "prisma/generated/client_users/libquery_engine-darwin.dylib.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "prisma/generated/client_users/schema.prisma")
